...
function myFunction(){
  console.log("Hello");
   $("#beginning_content").empty();
   var introParagraph = document.createElement("P");
  introParagraph.textContent = "You decide to go to Cozumel. As you arrive to the terminal, a man wearing large sunglasses holds a sign with your name on it.<br>You approach him and ask What is going on?";
  $("#beginning_content").append(introParagraph);
}
...
var Cozumel_Intro = document.createElement("div");

Cozumel_Intro.id = "Cozumel_Intro";
...
var homepage = document.createElement("P");
  ...
  introParagraph.textContent = "You decide to go to Cozumel. As you arrive to the terminal, a man wearing large sunglasses holds a sign with your name on it.<br>You approach him and ask What is going on?";
  $("#Cozumel_Intro").append(introParagraph);
...
var paragraph2 = document.createElement("P");
  ...
  // <p id="page1" class="text_border">Inside the package is a map of Cozumel, a pair of car keys, and directions to a diveshop.
  // <br>You arrive to the dive shop. 
  // <br> <img src="media/diveshop.png" style="height:200px;width:300px;"/></p>
  // <br> <p id="page1" class="text_border">The instructions say you must figure out how to complete three dives in a 24 period, including a dive of 80 feet.
  // <br> You have never learned to swim, not to mention scuba-dive. <br>And you are aware of the dangers of an air embolism, when one or more gas bubbles enter a vein or artery.
  // <br> <img src="media/air_embolism.jpg" style="height:200px;width:300px;/> 
  // <br>It can be lethal.</p>
  // <p id="page1" class="text_border">
  // <br>Do you 
  // <a href="#" id="Choose_To_Dive_Link">face your fears</a> or 
  // <a href="#" id="Back_Out_Link"> back out?</a></p>
//show paragraphs and divs on click 
//show div but hide classes on clicks
 //add fade in

//var divs=document.getElementById("Cozumel_Intro");
//var paragraphs=document.getElementById("page1");


//$("#Cozumel_Intro").click(function(){
  //  $("page1").show();

//});


//document.getElementById("Cozumel_Intro").onclick = function(){

$("#Cozumel").click(function(){
  var Cozumel_Intro1 = document.getElementById("Cozumel_Intro");

  var paragraph = document.createElement("P");
  Cozumel_Intro1.appendChild(paragraph);
...
$("body").append(Cozumel_Intro);


$("div").hide();

$("#beginning_content").show();
$("#intro").show();
