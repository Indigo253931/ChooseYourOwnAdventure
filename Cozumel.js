...
console.log("hello");
  ...
  introParagraph.textContent = "You decide to go to Cozumel. As you arrive to the terminal, a man wearing large sunglasses holds a sign with your name on it.<br>";
  ...
  p4.textContent="You have never learned to swim, not to mention scuba-dive. <br>And you are aware of the dangers of an air embolism, when one or more gas bubbles enter a vein or artery. <br>It can be lethal.";
  ...
  p5.textContent="You arrive to the dive shop. Do you <a href='#' id='Choose_To_Dive_Link'>face your fears</a> or 
//   // <a href="#" id="Back_Out_Link"> back out?";
...
button_text.textContent="You have played " + clicks + "times!";
