window.onload = function(){
  //$("beginning_content").remove();

console.log("hello");

  var body = document.querySelector("body");
  var beginning_content = document.createElement("div");
  var introParagraph = document.createElement("P");
  
  //beginning paragraphs 
  introParagraph.textContent = "You decide to go to Cozumel. As you arrive to the terminal, a man wearing large sunglasses holds a sign with your name on it.";
  beginning_content.appendChild(introParagraph);
  body.appendChild(beginning_content);
  
  var map_pic = document.createElement("IMG");
  map_pic.src="media/Cozumel.jpg";
  introParagraph.appendChild(map_pic);

  var p2 = document.createElement("P");
  p2.textContent="You approach him and ask 'What is going on?' He responds, 'Aqui esta tu paquete, y buena suerte.' and hands over a package before disappearing into the crowd.";
  beginning_content.appendChild(p2);

  var p3 = document.createElement("P");
  p3.textContent="Inside the package is a map of Cozumel, a pair of car keys, and directions to a diveshop. The instructions say you must figure out how to complete three dives in a 24 period, including a dive of 80 feet.";
  beginning_content.appendChild(p3);

  var p4 = document.createElement("P");
  p4.textContent="You have never learned to swim, not to mention scuba-dive. <br>And you are aware of the dangers of an air embolism, when one or more gas bubbles enter a vein or artery. It can be lethal.";
  beginning_content.appendChild(p4);
  var embolism = document.createElement("IMG");
  embolism.src="media/air_embolism.jpg";
  p4.appendChild(embolism);

  var p5 = document.createElement("P");
  p5.textContent="You arrive to the dive shop. Do you <a href='#' id='Choice_1'>face your fears</a> or <a href='id=Choice_2> back out?";

  //first choice (choose to dive)
  //create new div
  var ch1 = document.createElement("div");
  var ch1_p1 = document.createElement("P");
  ch1_p1.textContent="You decide to dive, despite your fear of drowning. You try your best to follow the directions of the scuba instructor. You first put the tank on the seat and sit down.";
  ch1.appendChild(ch1_p1);
  body.appendChild(ch1);

//   var ch1_p2 = document.createElement("P");
//   ch1_p2.textContent=


//   var ch1_p3 = document.createElement("P");
// ch1_p2.textContent=

//   var ch1_p4 = document.createElement("P");

//   ch1_p2.textContent=
//   var ch1_p5 = document.createElement("P");
  // var ch1_p2=document.createElement("P");
  // p2.textContent="Next, you buckle the Boyuncy Control vest and put the regulator in your mouth.<br><img src='media/bc_vest.jpg' style='height:200px;width:300px;'/><img src='media/regulator.jpg' style='height:200px;width:300px'br>Then, you pull on your fins and mask.<br><img src='media/mask.jpg' style='height:200px;width:300px;'/><img src='media/fins.jpg' style='height:200px;width:300px;'/><br>Holding the regulator and mask with one hand, you use your other hand to push backwards into the open water.";
  // // var choice1_p3=document.createElement("P");
  // p3.textContent="";
  //  var choice1_p4=document.createElement("P");
  // p4.textContent="";
  //  var choice1_p5=document.createElement("P");
  // p5.textContent="";
  //  var Choice1_p6=document.createElement("P");
  // p6.textContent="";
  //  var Choice1_p7=document.createElement("P");
  // p7.textContent="";

var choice2 = document.createElement("div");
var choice2_p2 = document.createElement("P");
  p1.textContent="You are too afraid of drowning and decide not to back out. You recieve a phone call. A recording tells you your loved one has died.";


  
//BUTTON DISPLAYS NUMBER OF TIMES PLAYED
...
// play_again.innerHTML = "You have played " + clicks + "times!";
// body.appendChild(play_again);

// console.log("play_again")
// play_again.onclick = function() {
// clicks++;
// console.log("You have played " + clicks + "times!");
// };
...
//   // <br>You arrive to the dive shop. 
//   // <br> <img src="media/diveshop.png" style="height:200px;width:300px;"/></p
//   // <br> <img src="media/air_embolism.jpg" style="height:200px;width:300px;/> 
//   // <p id="page1" class="text_border">
//   // <br>Do you 
//   // <a href="#" id="Choose_To_Dive_Link">face your fears</a> or 
//   // <a href="#" id="Back_Out_Link"> back out?</a></p>


//  console.log(Cozumel_Intro1);
//   //$("#Cozumel_Intro").html(paragraph);
//   var image = document.createElement("IMG");
//  image.src="media/Cozumel.jpg";
//  image.width="";
//  image.height="";
...
// //Get_Lost={
//   //  html:'<div id="Get_Lost"><p class="Player_Loses_Cozumel">You choose not to follow after the turtle. Not knowing where you are, you decide to resurface. Unable to find your way, the current pulls you to the Carribean sea. Eventually you drown.<br> Click <a href="CYOA_intro.html"> here </a> to play again.</p><br><img src="media/drowning.gif"/></div>'};

// //Player_Loses_Cozumel={
//  //  html:'<div id="Player_Loses_Cozumel"><p class="text_border">You decide not to dive. As you walk out of the shop, the phone rings again. You answer and hear the scream, followed by a shot.<br> Click <a href="CYOA_intro.html"> here </a> to play again.</p></div>'};   

// //Player_Wins_Cozumel={
//   //  html:'<div id="Player_Wins_Cozumel"><p class="text_border">After 20 minutes pass, you head back to the surface.<br>As you walk out from the lagoon, you see your loved one waiting for you by the shore. The three of you sit on the sand and watch hundreds of newly-hatched baby turtles crawl their way into the sea.<br> Click <a href="CYOA_intro.html"> here </a> to play again.</p></div>'};
...
// $("#Back_Out_Link").on("click", function(){
//         alert("You lost!");
//     });

// $("#Get_Lost_Link").on("click", function(){
//         alert("You lost!");
//     });
// });
